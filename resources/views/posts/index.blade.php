        ...
        <div class="row gx-4 gx-lg-5 justify-content-center mt-5">
            <form action="{{ route('post') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="desc" id="desc" placeholder="" required value="{{ old('desc') }}">
                  </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control" name="body" id="body" rows="3" value="{{ old('content') }}"></textarea>
                </div>
